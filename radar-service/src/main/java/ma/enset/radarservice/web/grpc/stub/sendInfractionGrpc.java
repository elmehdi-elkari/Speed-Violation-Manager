...
public final class sendInfractionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.radarservice.web.grpc.stub.Radar.Empty,
      ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo> getSendMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "send",
      requestType = ma.enset.radarservice.web.grpc.stub.Radar.Empty.class,
      responseType = ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<ma.enset.radarservice.web.grpc.stub.Radar.Empty,
      ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo> getSendMethod() {
    io.grpc.MethodDescriptor<ma.enset.radarservice.web.grpc.stub.Radar.Empty, ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo> getSendMethod;
      ...
      synchronized (sendInfractionGrpc.class) {
        if ((getSendMethod = sendInfractionGrpc.getSendMethod) == null) {
          sendInfractionGrpc.getSendMethod = getSendMethod = 
              io.grpc.MethodDescriptor.<ma.enset.radarservice.web.grpc.stub.Radar.Empty, ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "sendInfraction", "send"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.radarservice.web.grpc.stub.Radar.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo.getDefaultInstance()))
  ...
  public static abstract class sendInfractionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void send(ma.enset.radarservice.web.grpc.stub.Radar.Empty request,
        io.grpc.stub.StreamObserver<ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncServerStreamingCall(
              new MethodHandlers<
                ma.enset.radarservice.web.grpc.stub.Radar.Empty,
                ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo>(
                  this, METHODID_SEND)))
          .build();
    }
  }
  ...
  public static final class sendInfractionBlockingStub extends io.grpc.stub.AbstractStub<sendInfractionBlockingStub> {
    ...
    /**
     */
    public java.util.Iterator<ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo> send(
        ma.enset.radarservice.web.grpc.stub.Radar.Empty request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEND:
          serviceImpl.send((ma.enset.radarservice.web.grpc.stub.Radar.Empty) request,
              (io.grpc.stub.StreamObserver<ma.enset.radarservice.web.grpc.stub.Radar.infractionInfo>) responseObserver);
          break;
        default:
  ...
  private static abstract class sendInfractionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ma.enset.radarservice.web.grpc.stub.Radar.getDescriptor();
    }
